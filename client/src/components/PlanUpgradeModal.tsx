        ...
        <div style={{ border: `1.5px solid ${color}25`, background: '#fff', padding: '28px 24px', borderRadius: '24px', display: 'flex', flexDirection: 'column', transition: 'all 0.25s', boxShadow: '0 4px 16px rgba(0,0,0,0.04)' }}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                ...
                <button onClick={onSelect} disabled={loading}
                    style={{ width: '100%', padding: '0.7rem', background: '#635BFF', color: '#fff', borderRadius: '12px', fontWeight: 800, border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', fontSize: '0.85rem' }}>
                    {loading ? <Loader2 size={16} className="animate-spin" /> : (
                        <>
                            <CreditCard size={16} />
                            <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
                                <svg width="22" height="14" viewBox="0 0 45 28" fill="none">
                                ...
                                <svg width="22" height="14" viewBox="0 0 45 28" fill="none">
                                    <rect width="45" height="28" rx="4" fill="#fff" />
                                    <circle cx="17" cy="14" r="9" fill="#EB001B" fillOpacity="0.85" />
                                    <circle cx="28" cy="14" r="9" fill="#F79E1B" fillOpacity="0.85" />
                                </svg>
                            </div>
                            Pagar com Cartão
                        </>
                ...
                {/* PayPal */}
                <div style={{ background: '#fefce8', borderRadius: '12px', border: '1px solid #fde68a', overflow: 'hidden', minHeight: '44px', position: 'relative' }}>
                    <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', zIndex: 1, pointerEvents: 'none' }}>
                ...
                <button onClick={onManual}
                    style={{ width: '100%', padding: '0.65rem', background: '#f9fafb', color: '#374151', borderRadius: '12px', fontWeight: 700, border: '1px solid #e5e7eb', cursor: 'pointer', fontSize: '0.82rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                    🏦 Transferência / M-Pesa / e-Mola
                </button>
            </div>
        </div>
    );
