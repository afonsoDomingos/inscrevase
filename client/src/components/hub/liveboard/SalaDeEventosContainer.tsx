                ...
                <div style={{
                    ...
                    <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'flex-start', gap: isMobile ? '10px' : '15px', overflow: 'hidden' }}>
                        ...
                        <div>
                            ...
                            {!isMobile && (
                                <>
                                    <div style={{ fontSize: '0.75rem', fontWeight: 600, opacity: 0.6, color: isDark ? '#fff' : '#111', display: 'flex', alignItems: 'center', gap: '8px' }}>
                                        <span>{mentorData.title}</span>
                                        {isMentorSpeaking && (
                                            <motion.div
                                        ...
                                        {/* Separador e Links Sociais inline com o título para poupar espaço vertical e evitar transbordo da borda */}
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginLeft: '4px' }}>
                                            <div style={{ width: '3px', height: '3px', borderRadius: '50%', background: isDark ? '#fff' : '#111', opacity: 0.3 }} />

                                            {mentorData.socialLinks?.instagram && (
                                                <a href={mentorData.socialLinks.instagram} target="_blank" rel="noopener noreferrer" style={{ color: isDark ? '#fff' : '#111', opacity: 0.5, display: 'flex' }}>
                                                    <Instagram size={14} />
                                                </a>
                                            )}
                                            {mentorData.socialLinks?.linkedin && (
                                                <a href={mentorData.socialLinks.linkedin} target="_blank" rel="noopener noreferrer" style={{ color: isDark ? '#fff' : '#111', opacity: 0.5, display: 'flex' }}>
                                                    <Linkedin size={14} />
                                                </a>
                                            )}
                                            {mentorData.socialLinks?.website && (
                                                <a href={mentorData.socialLinks.website} target="_blank" rel="noopener noreferrer" style={{ color: isDark ? '#fff' : '#111', opacity: 0.5, display: 'flex' }}>
                                                    <Globe size={14} />
                                                </a>
                                            )}
                                            {mentorData.whatsapp && (
                                                <a
                                                    href={`https://wa.me/${mentorData.whatsapp.replace(/\D/g, '')}`}
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                                    title="WhatsApp"
                                                    style={{ textDecoration: 'none', opacity: 0.85, display: 'flex', alignItems: 'center' }}
                                                >
