                                    ...
                                    <div style={{ display: 'flex', gap: '10px', marginTop: '4px' }}>
                                        ...
                                        {mentorData.whatsapp && (
                                            <a
                                                ...
                                                title="WhatsApp"
                                                style={{ textDecoration: 'none', opacity: 0.85, display: 'inline-flex', verticalAlign: 'middle' }}
                                            >
                                                <svg width="14" height="14" viewBox="0 0 24 24" fill="#25D366" xmlns="http://www.w3.org/2000/svg" style={{ verticalAlign: 'middle' }}>
