...
import { CheckCircle, Zap, ShieldCheck, Crown, Lock, Loader2 } from "lucide-react";
...
export default function PlanCard({
    ...
    return (
        ...
        >
            ...
            <div style={{ marginBottom: '1.5rem', fontSize: '2.8rem', fontWeight: 900, textAlign: 'center', color: recommended || isEnterprise ? '#D4AF37' : '#fff', position: 'relative', zIndex: 2 }}>
