    ...
    return (
        <main style={{ background: '#fff', minHeight: '100vh' }}>
            ...
            <section style={{
                ...
                >
                    <Scale size={60} color="#1452AD" style={{ marginBottom: '25px' }} />
                    <h1 style={{
                        ...
                        Termos de <span style={{ color: '#1452AD' }}>Uso</span>
                    </h1>
                    <p style={{
                        fontSize: '1.2rem',
                        ...
                        Leia atentamente os termos e condições que regem o uso da plataforma Inscreva-se.
                    </p>
                </motion.div>
            </section>
