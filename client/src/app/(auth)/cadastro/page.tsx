...
function RegisterContent() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!formData.role) {
            toast.error('Por favor, selecione o seu perfil (Mentor, Participante, etc.) antes de continuar.');
            return;
        }
                ...
                >
                    ...
                    <div style={{ display: 'flex', gap: '1rem' }}>
                        <button onClick={() => {
                            ...
                            window.location.href = `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api'}/auth/google?role=${formData.role}`;
                        }} style={{ flex: 1, padding: '0.7rem', background: '#fff', color: '#000', border: 'none', borderRadius: '12px', fontWeight: 600, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', fontSize: '0.9rem' }}>
                        ...
                        <button onClick={() => {
                            ...
                            window.location.href = `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api'}/auth/linkedin?role=${formData.role}`;
                        }} style={{ flex: 1, padding: '0.7rem', background: '#0077b5', color: '#fff', border: 'none', borderRadius: '12px', fontWeight: 600, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', fontSize: '0.9rem' }}>
