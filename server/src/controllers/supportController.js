...
exports.createPublicMessage = async (req, res) => {
    try {
        ...
        try {
            // NOTA: Resend em modo sandbox só permite enviar para o email verificado (inscrevase.events@gmail.com)
            ...
            const [adminResult, userResult] = await Promise.all([
                ...
                resend.emails.send({
                    ...
                    to: 'inscrevase.events@gmail.com',
                ...
                resend.emails.send({
                    from: 'Inscreva-se <onboarding@resend.dev>',
                    to: 'inscrevase.events@gmail.com', // Temporariamente para admin
                    ...
                    html: `
                        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                            ...
                            <p style="font-size: 12px; color: #999; text-align: center;">
                                ...
                                Email: inscrevase.events@gmail.com
                            </p>
                        </div>
                    `
                })
